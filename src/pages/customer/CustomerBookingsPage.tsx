...
import { getServiceIcon, ClipboardList, ArrowRight } from '@/components/Icons';
...
export function CustomerBookingsPage() {
  ...
  const filters: { label: string; value: BookingStatus | 'all'; count: number }[] = [
    ...
    { label: 'Active', value: 'accepted', count: bookings.filter((b) => b.status === 'accepted').length },
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold font-display text-neutral-900 mb-2">My Bookings</h1>
        <p className="text-neutral-500 mb-6">Track and manage all your service bookings.</p>
        ...
        {loading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <p className="text-neutral-500 font-medium mb-2">No bookings here</p>
            <p className="text-sm text-neutral-400 mb-4">Start by browsing our services.</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-neutral-500 truncate">{booking.provider?.full_name}</p>
